<%-- 
    Document   : handbook
    Created on : Oct 9, 2021, 8:14:20 PM
    Author     : nct68
--%>
...
<div class="container-fluid" style="width: 95%">
    <h2 class="font-weight-bold text-info text-center">CẨM NANG</h2>
    
    <div class="mt-4">
        <h4 class="font-weight-bold">BÍ QUYẾT TÌM VIỆC</h4>
        
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <a href="<c:url value="/handbook/bqtv-1" />">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <a href="<c:url value="/handbook/bqtv-2" />">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <a href="<c:url value="/handbook/bqtv-3" />">
    ...
    <div class="mt-4">
        <h4 class="font-weight-bold">THĂNG TIẾN SỰ NGHIỆP</h4>
        
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <a href="<c:url value="/handbook/ttcv-1" />">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <a href="<c:url value="/handbook/ttcv-2" />">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <a href="<c:url value="/handbook/ttcv-3" />">
    ...
    <div class="font-weight-bold text-right mr-3 mt-3">
        --- Nguồn: Careerbuilder ---
    </div>
