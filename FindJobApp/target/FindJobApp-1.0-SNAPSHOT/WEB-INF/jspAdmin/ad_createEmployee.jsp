...
<c:if test="${typeUser == 'edit-employee'}">
    <c:url value="/admin/employees/${user.id}/edit" var="action" />
</c:if>
...
<div>
    ...
    <c:if test="${typeUser == 'create-employee'}">
        <form:form method="post" action="${action}" modelAttribute="user" enctype="multipart/form-data"
            ...
            <h3 style="text-align: center; padding-top: 20px; margin: 0;">Tạo mới nhân viên</h3>
    ...
    <c:if test="${typeUser == 'edit-employee'}">
        <form:form method="patch" action="${action}" modelAttribute="user" enctype="multipart/form-data"
            ...
            <h3 style="text-align: center; padding-top: 20px; margin: 0;">Thông tin nhân viên ${user.username}</h3>
            <c:if test="${errorText != null}">
                <div class="alert alert-warning">
                    ${errorText}
                </div>
